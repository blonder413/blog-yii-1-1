	...
	<div id="mainmenu">
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				...
				array('label'=>'Artículo', 'url'=>array('/admin/articulo/admin'), 'visible'=> !Yii::app()->user->isGuest),
				array('label'=>'Categoría', 'url'=>array('/admin/categoria/admin'), 'visible'=> !Yii::app()->user->isGuest),
