...
<article>
	...
	<h2>
		<img width='50' src="<?php echo Yii::app()->request->baseUrl; ?>/images/categorias/<?php echo $value->categoria->imagen; ?>">
		<?php echo CHtml::link($value->titulo, array('/articulo/' . $value->slug)); ?>
	</h2>
	<div>
	Publicado por <?php echo $value->createdBy->name; ?> | 
	Publicado el <?php echo Yii::app()->dateFormatter->formatDateTime($value->created_at, 'full', 'short');  ?>
