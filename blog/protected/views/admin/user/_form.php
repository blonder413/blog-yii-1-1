...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'password_reset_token'); ?>
		<?php echo $form->textField($model,'password_reset_token',array('size'=>60,'maxlength'=>255)); ?>
		<?php echo $form->error($model,'password_reset_token'); ?>
	</div>
